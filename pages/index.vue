...
<i18n lang="json">
{
  ...
  "ru": {
    ...
    "100% real photos of every candidate, allowing to pick the escort that fully corresponds to the set preferences": "В нашем элитном эскорт агентстве: фото моделей полностью соответствуют действительности",
