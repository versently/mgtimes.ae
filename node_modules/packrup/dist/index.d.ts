...
declare type ResolveFn = (ctx: Context) => string;
...
export { InternalKeySymbol, TransformValueOptions, UnpackArrayOptions, packArray, packObject, packString, unpackToArray, unpackToString };
