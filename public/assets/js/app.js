...
//     let fOld = Array.from(old)[0];
//     let tOld = Array.from(old)[1];
//     let thOld = Array.from(old)[2];

//     console.log(tOld + old)
//     if (!(fOld == 'h')) {
//         el.setAttribute('href', ('/ru' + old))
//     }
//     if ((tOld + thOld == 'en')) {
...
/*------swiper slider----------*/
  ...
  if (indexBlocker) {
//   document
//     .querySelector(".models-section__swiper-wrapper")
