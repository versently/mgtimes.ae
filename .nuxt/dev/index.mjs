...
import { defineEventHandler, handleCacheHeaders, isEvent, createEvent, getRequestHeader, splitCookiesString, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, getQuery as getQuery$1, getCookie, createError, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, setCookie, appendHeader, parseCookies, getHeaders, getMethod, isMethod, readBody, getResponseStatusText } from 'file:///Users/vitaly/Sites/hostiman_artur/mgtimes_nuxt/node_modules/h3/dist/index.mjs';
import CredentialsProvider from 'file:///Users/vitaly/Sites/hostiman_artur/mgtimes_nuxt/node_modules/next-auth/providers/credentials.js';
import { AuthHandler } from 'file:///Users/vitaly/Sites/hostiman_artur/mgtimes_nuxt/node_modules/next-auth/core/index.js';
import defu, { defuFn, defu as defu$1 } from 'file:///Users/vitaly/Sites/hostiman_artur/mgtimes_nuxt/node_modules/defu/dist/defu.mjs';
...
import getURL from 'file:///Users/vitaly/Sites/hostiman_artur/mgtimes_nuxt/node_modules/requrl/dist/requrl.js';
...
import { u as u$1 } from 'file:///Users/vitaly/Sites/hostiman_artur/mgtimes_nuxt/node_modules/unist-builder/index.js';
...
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/vitaly/Sites/hostiman_artur/mgtimes_nuxt/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _QFQQvvoozB = (function(nitro) {
...
const _T7jZEjEHxd = defineNitroPlugin(() => {
  try {
    getServerOrigin();
  } catch (error) {
    {
...
const _lazy_bjzMWt = () => Promise.resolve().then(function () { return _____$1; });
...
const handlers = [
  { route: '/api/auth/**', handler: _lazy_bjzMWt, lazy: true, middleware: false, method: undefined },
...
const _____ = NuxtAuthHandler({
  providers: [
    CredentialsProvider.default({
      ...
      credentials: {
        username: { label: "Username", type: "text", placeholder: "1jsmith" },
...
const getClientManifest = () => import('file:///Users/vitaly/Sites/hostiman_artur/mgtimes_nuxt/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/vitaly/Sites/hostiman_artur/mgtimes_nuxt/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
