...
export const additionalMessages = Object({"en":[],"ru":[],})
...
export const resolveNuxtI18nOptions = async (context) => {
 ...
 const vueI18nConfigLoader = async (context, loader) => {
  ...
  const vueI18n = await vueI18nConfigLoader(context, (() => import("\u0000@nuxtjs/i18n/__config__?target=../i18n.config.ts&c=6558258c" /* webpackChunkName: "i18n_config_6558258c" */)))
