...
import { e as useNuxtApp, c as createError, f as useRequestEvent, u as useRuntimeConfig } from "../server.mjs";
...
import "devalue";
import { w as withContentBase, a as addPrerenderPath, s as shouldUseClientDB } from "./utils-6cb5eff9.js";
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import("./client-db-e217356d.js").then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-7e240301.js.map
