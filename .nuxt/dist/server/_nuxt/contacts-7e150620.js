...
function block0(Component) {
  ...
  _Component.__i18n.push({
    ...
    "resource": {
      "en": {
        "title": { "type": 0, "body": { "type": 2, "items": [{ "type": 3 }], "static": "Contacts - Escort agency «Mgtimes» in Dubai" } },
        "description": { "type": 0, "body": { "type": 2, "items": [{ "type": 3 }], "static": "Contact the contact numbers of the elite escort agency Mgtimes, the best models of Dubai! Organization of rest and meetings! 📞 +971 58 525 2213 ⚡" } },
      ...
      "ru": {
        "title": { "type": 0, "body": { "type": 2, "items": [{ "type": 3 }], "static": "Контакты - Эскорт агентство «Mgtimes»" } },
        "description": { "type": 0, "body": { "type": 2, "items": [{ "type": 3 }], "static": "Обращайтесь по контактным телефонам элитного эскорт агентства Mgtimes, лучшие модели Дубая! Организация отдыха и встреч! 📞 +971 58 525 2213 ⚡" } },
...
//# sourceMappingURL=contacts-7e150620.js.map
