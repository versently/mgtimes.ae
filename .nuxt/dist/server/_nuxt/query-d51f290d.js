...
import { e as useNuxtApp, c as createError, b as useRequestEvent, d as useRuntimeConfig } from "../server.mjs";
...
import "defu";
import "klona";
import { w as withContentBase, a as addPrerenderPath, s as shouldUseClientDB } from "./utils-2bbdf9e2.js";
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import("./client-db-552cf684.js").then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-d51f290d.js.map
