...
import { f as useNuxtApp, c as createError, d as useRequestEvent, e as useRuntimeConfig } from "../server.mjs";
...
import "devalue";
import "klona";
import { w as withContentBase, a as addPrerenderPath, s as shouldUseClientDB } from "./utils-3b18a1a6.js";
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import("./client-db-b8f1fcff.js").then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-78cd0dad.js.map
