import { reactive, hasInjectionContext, getCurrentInstance, toRef, isRef, inject, nextTick, version, ref, watchEffect, watch, unref, shallowRef, shallowReactive, isReadonly, isShallow, isReactive, toRaw, defineAsyncComponent, defineComponent, h, effectScope, onUnmounted, computed, Fragment, createVNode, Text, Suspense, mergeProps, Transition, provide, withCtx, useSSRContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/casting-95afa81f.js").then((m) => m.default || m)
  },
  {
    name: "casting___ru",
    path: "/ru/casting",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/contacts-9aa624bb.js").then((m) => m.default || m)
  },
  {
    name: "contacts___ru",
    path: "/ru/contacts",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-3d8272d2.js").then((m) => m.default || m)
  },
  {
    name: "index___ru",
    path: "/ru",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_...slug_-31747570.js").then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-84c1559f.js").then((m) => m.default || m)
  },
  {
    name: "media___ru",
    path: "/ru/media",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_...slug_-1318e198.js").then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-5fccfa0f.js").then((m) => m.default || m)
  },
  {
    name: "models___ru",
    path: "/ru/models",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/privacy-policy-799844b4.js").then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_...slug_-9f071308.js").then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-d8b07be1.js").then((m) => m.default || m)
  },
  {
    name: "services___ru",
    path: "/ru/services",
...
const LazyContentDoc = defineAsyncComponent(() => import("./_nuxt/ContentDoc-a5c59cd8.js").then((r) => r.default));
const LazyContentList = defineAsyncComponent(() => import("./_nuxt/ContentList-9870115f.js").then((r) => r.default));
const LazyContentNavigation = defineAsyncComponent(() => import("./_nuxt/ContentNavigation-89511583.js").then((r) => r.default));
const LazyContentQuery = defineAsyncComponent(() => import("./_nuxt/ContentQuery-3fcff742.js").then((r) => r.default));
const LazyContentRenderer = defineAsyncComponent(() => import("./_nuxt/ContentRenderer-44088b12.js").then((r) => r.default));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import("./_nuxt/ContentRendererMarkdown-30b2a030.js").then((r) => r.default));
const LazyContentSlot = defineAsyncComponent(() => import("./_nuxt/ContentSlot-a313c999.js").then((r) => r.default));
...
const LazyMarkdown = defineAsyncComponent(() => import("./_nuxt/Markdown-9d83c195.js").then((r) => r.default));
const LazyProseA = defineAsyncComponent(() => import("./_nuxt/ProseA-1cfdad2e.js").then((r) => r.default));
const LazyProseBlockquote = defineAsyncComponent(() => import("./_nuxt/ProseBlockquote-1a2d5a43.js").then((r) => r.default));
const LazyProseCode = defineAsyncComponent(() => import("./_nuxt/ProseCode-9cd09ca5.js").then((r) => r.default));
const LazyProseCodeInline = defineAsyncComponent(() => import("./_nuxt/ProseCodeInline-469bb623.js").then((r) => r.default));
const LazyProseEm = defineAsyncComponent(() => import("./_nuxt/ProseEm-daf49df7.js").then((r) => r.default));
const LazyProseH1 = defineAsyncComponent(() => import("./_nuxt/ProseH1-650a2af9.js").then((r) => r.default));
const LazyProseH2 = defineAsyncComponent(() => import("./_nuxt/ProseH2-836103f0.js").then((r) => r.default));
const LazyProseH3 = defineAsyncComponent(() => import("./_nuxt/ProseH3-e7b21f78.js").then((r) => r.default));
const LazyProseH4 = defineAsyncComponent(() => import("./_nuxt/ProseH4-6c5da784.js").then((r) => r.default));
const LazyProseH5 = defineAsyncComponent(() => import("./_nuxt/ProseH5-85c84ca6.js").then((r) => r.default));
const LazyProseH6 = defineAsyncComponent(() => import("./_nuxt/ProseH6-644e14ae.js").then((r) => r.default));
const LazyProseHr = defineAsyncComponent(() => import("./_nuxt/ProseHr-ef4ef818.js").then((r) => r.default));
const LazyProseImg = defineAsyncComponent(() => import("./_nuxt/ProseImg-29d91672.js").then((r) => r.default));
const LazyProseLi = defineAsyncComponent(() => import("./_nuxt/ProseLi-222b7499.js").then((r) => r.default));
const LazyProseOl = defineAsyncComponent(() => import("./_nuxt/ProseOl-64341a4f.js").then((r) => r.default));
const LazyProseP = defineAsyncComponent(() => import("./_nuxt/ProseP-22db6751.js").then((r) => r.default));
const LazyProseStrong = defineAsyncComponent(() => import("./_nuxt/ProseStrong-a940ccb7.js").then((r) => r.default));
const LazyProseTable = defineAsyncComponent(() => import("./_nuxt/ProseTable-eb886f01.js").then((r) => r.default));
const LazyProseTbody = defineAsyncComponent(() => import("./_nuxt/ProseTbody-0cb72462.js").then((r) => r.default));
const LazyProseTd = defineAsyncComponent(() => import("./_nuxt/ProseTd-a4cbafc8.js").then((r) => r.default));
const LazyProseTh = defineAsyncComponent(() => import("./_nuxt/ProseTh-54bc4db9.js").then((r) => r.default));
const LazyProseThead = defineAsyncComponent(() => import("./_nuxt/ProseThead-3a0aab84.js").then((r) => r.default));
const LazyProseTr = defineAsyncComponent(() => import("./_nuxt/ProseTr-d01b9f83.js").then((r) => r.default));
const LazyProseUl = defineAsyncComponent(() => import("./_nuxt/ProseUl-83cbb99f.js").then((r) => r.default));
...
const resolveNuxtI18nOptions = async (context) => {
  ...
  const vueI18n = await vueI18nConfigLoader(() => import(
    "./_nuxt/i18n.options-f86d815b.js"
...
const layouts = {
  default: /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/default-ad5e56b7.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-404-7d8b7364.js").then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-500-50ab1f77.js").then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/island-renderer-8d676b9f.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
