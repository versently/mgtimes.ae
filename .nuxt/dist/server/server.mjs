...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/casting-c81caf36.js").then((m) => m.default || m)
  },
  {
    name: "casting___ru",
    path: "/ru/casting",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_...slug_-d8c73eab.js").then((m) => m.default || m)
  },
  {
    name: "cities-slug___ru",
    path: "/ru/cities/:slug(.*)*",
    meta: {},
    alias: [],
    redirect: void 0,
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/contacts-f75b7c3a.js").then((m) => m.default || m)
  },
  {
    name: "contacts___ru",
    path: "/ru/contacts",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-31461807.js").then((m) => m.default || m)
  },
  {
    name: "index___ru",
    path: "/ru",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_...slug_-a4831ff8.js").then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-f2ea5a58.js").then((m) => m.default || m)
  },
  {
    name: "media___ru",
    path: "/ru/media",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_...slug_-7cddf39e.js").then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-78a9f14b.js").then((m) => m.default || m)
  },
  {
    name: "models___ru",
    path: "/ru/models",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/privacy-policy-f789deb9.js").then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_...slug_-7300eea9.js").then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-0996b4d2.js").then((m) => m.default || m)
  },
  {
    name: "services___ru",
    path: "/ru/services",
  ...
  {
    name: "services-parties-in-dubai-slug___en",
    path: "/services/parties-in-dubai/:slug()",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_slug_-45966e4e.js").then((m) => m.default || m)
  },
  {
    name: "services-parties-in-dubai-slug___ru",
    path: "/ru/services/parties-in-dubai/:slug()",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_slug_-45966e4e.js").then((m) => m.default || m)
  ...
  {
    name: "services-parties-in-dubai___en",
    path: "/services/parties-in-dubai",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-a073f103.js").then((m) => m.default || m)
  },
  {
    name: "services-parties-in-dubai___ru",
    path: "/ru/services/parties-in-dubai",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-a073f103.js").then((m) => m.default || m)
...
const trailing_45slash_45global = /* @__PURE__ */ defineNuxtRouteMiddleware((to, from) => {
...
const without_45php_45global = /* @__PURE__ */ defineNuxtRouteMiddleware((to, from) => {
...
const LazyContentDoc = defineAsyncComponent(() => import("./_nuxt/ContentDoc-1389021c.js").then((r) => r.default));
const LazyContentList = defineAsyncComponent(() => import("./_nuxt/ContentList-3cc27dc7.js").then((r) => r.default));
const LazyContentNavigation = defineAsyncComponent(() => import("./_nuxt/ContentNavigation-b33814c7.js").then((r) => r.default));
const LazyContentQuery = defineAsyncComponent(() => import("./_nuxt/ContentQuery-e032db68.js").then((r) => r.default));
const LazyContentRenderer = defineAsyncComponent(() => import("./_nuxt/ContentRenderer-96552a5f.js").then((r) => r.default));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import("./_nuxt/ContentRendererMarkdown-326f59f8.js").then((r) => r.default));
const LazyContentSlot = defineAsyncComponent(() => import("./_nuxt/ContentSlot-30663915.js").then((r) => r.default));
...
const LazyMarkdown = defineAsyncComponent(() => import("./_nuxt/Markdown-0d28d388.js").then((r) => r.default));
const LazyProseA = defineAsyncComponent(() => import("./_nuxt/ProseA-b7addeaa.js").then((r) => r.default));
const LazyProseBlockquote = defineAsyncComponent(() => import("./_nuxt/ProseBlockquote-9fb10426.js").then((r) => r.default));
const LazyProseCode = defineAsyncComponent(() => import("./_nuxt/ProseCode-947fb7b1.js").then((r) => r.default));
const LazyProseCodeInline = defineAsyncComponent(() => import("./_nuxt/ProseCodeInline-45341655.js").then((r) => r.default));
const LazyProseEm = defineAsyncComponent(() => import("./_nuxt/ProseEm-133ed4ec.js").then((r) => r.default));
const LazyProseH1 = defineAsyncComponent(() => import("./_nuxt/ProseH1-24cfb2f7.js").then((r) => r.default));
const LazyProseH2 = defineAsyncComponent(() => import("./_nuxt/ProseH2-b61e66bf.js").then((r) => r.default));
const LazyProseH3 = defineAsyncComponent(() => import("./_nuxt/ProseH3-70a01287.js").then((r) => r.default));
const LazyProseH4 = defineAsyncComponent(() => import("./_nuxt/ProseH4-7746a647.js").then((r) => r.default));
const LazyProseH5 = defineAsyncComponent(() => import("./_nuxt/ProseH5-0a048353.js").then((r) => r.default));
const LazyProseH6 = defineAsyncComponent(() => import("./_nuxt/ProseH6-2a5afd4a.js").then((r) => r.default));
const LazyProseHr = defineAsyncComponent(() => import("./_nuxt/ProseHr-13ebe21e.js").then((r) => r.default));
const LazyProseImg = defineAsyncComponent(() => import("./_nuxt/ProseImg-b4f9e605.js").then((r) => r.default));
const LazyProseLi = defineAsyncComponent(() => import("./_nuxt/ProseLi-5a798948.js").then((r) => r.default));
const LazyProseOl = defineAsyncComponent(() => import("./_nuxt/ProseOl-ab3b55e5.js").then((r) => r.default));
const LazyProseP = defineAsyncComponent(() => import("./_nuxt/ProseP-ff60f1d2.js").then((r) => r.default));
const LazyProseStrong = defineAsyncComponent(() => import("./_nuxt/ProseStrong-81ddba79.js").then((r) => r.default));
const LazyProseTable = defineAsyncComponent(() => import("./_nuxt/ProseTable-9863c01d.js").then((r) => r.default));
const LazyProseTbody = defineAsyncComponent(() => import("./_nuxt/ProseTbody-0c7504f6.js").then((r) => r.default));
const LazyProseTd = defineAsyncComponent(() => import("./_nuxt/ProseTd-4753dc21.js").then((r) => r.default));
const LazyProseTh = defineAsyncComponent(() => import("./_nuxt/ProseTh-06163fea.js").then((r) => r.default));
const LazyProseThead = defineAsyncComponent(() => import("./_nuxt/ProseThead-6fc58e05.js").then((r) => r.default));
const LazyProseTr = defineAsyncComponent(() => import("./_nuxt/ProseTr-354098c9.js").then((r) => r.default));
const LazyProseUl = defineAsyncComponent(() => import("./_nuxt/ProseUl-80e28547.js").then((r) => r.default));
...
const layouts = {
  default: () => import("./_nuxt/default-ef5c97a3.js").then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-404-34ae01d6.js").then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-500-9610b918.js").then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/island-renderer-ea5b6974.js").then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
