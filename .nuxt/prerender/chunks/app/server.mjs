...
import { $fetch as $fetch$1 } from 'file:///Users/vitaly/Sites/hostiman_artur/mgtimes_nuxt/node_modules/ofetch/dist/node.mjs';
...
import { parse, serialize } from 'file:///Users/vitaly/Sites/hostiman_artur/mgtimes_nuxt/node_modules/cookie-es/dist/index.mjs';
import isHTTPS from 'file:///Users/vitaly/Sites/hostiman_artur/mgtimes_nuxt/node_modules/is-https/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file:///Users/vitaly/Sites/hostiman_artur/mgtimes_nuxt/node_modules/vue/server-renderer/index.mjs';
import { defu } from 'file:///Users/vitaly/Sites/hostiman_artur/mgtimes_nuxt/node_modules/defu/dist/defu.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/casting-af1c0ad3.mjs').then((m) => m.default || m)
  },
  {
    name: "casting___ru",
    path: "/ru/casting",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/contacts-bb449929.mjs').then((m) => m.default || m)
  },
  {
    name: "contacts___ru",
    path: "/ru/contacts",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-beda10fe.mjs').then((m) => m.default || m)
  },
  {
    name: "index___ru",
    path: "/ru",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_...slug_-5d6ff1ff.mjs').then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-99d6ce20.mjs').then((m) => m.default || m)
  },
  {
    name: "media___ru",
    path: "/ru/media",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_...slug_-99a96abe.mjs').then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-830c5b8e.mjs').then((m) => m.default || m)
  },
  {
    name: "models___ru",
    path: "/ru/models",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/privacy-policy-3f1c73ac.mjs').then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_...slug_-f46149a8.mjs').then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-b6bd95c5.mjs').then((m) => m.default || m)
  },
  {
    name: "services___ru",
    path: "/ru/services",
...
const resolveNuxtI18nOptions = async (context) => {
  ...
  const vueI18n = await vueI18nConfigLoader(context, () => import(
    './_nuxt/i18n.options-9b03bb04.mjs'
...
const layouts = {
  default: () => import('./_nuxt/default-9dc08c5d.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-73e9a13f.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, useState as a, useRouter as b, createError as c, useRoute as d, entry$1 as default, useHead as e, useNuxtApp as f, useRequestEvent as g, useI18n as h, useLocalePath as i, getComposer as j, useSwitchLocalePath as k, useLocaleHead as l, navigateTo as n, precompileMessages as p, sharedExports as s, useRuntimeConfig as u };
