import { hasInjectionContext, getCurrentInstance, version, unref, inject, toRef, isRef, defineAsyncComponent, defineComponent, h, onUnmounted, ref, computed, watch, Fragment, useSSRContext, createApp, reactive, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, shallowRef, shallowReactive, isReadonly, Text, isShallow, isReactive, toRaw, effectScope, withCtx, mergeProps, nextTick, Suspense, Transition } from 'file:///Users/vitaly/Sites/hostiman_artur/mgtimes_nuxt/node_modules/vue/index.mjs';
...
import { getContext } from 'file:///Users/vitaly/Sites/hostiman_artur/mgtimes_nuxt/node_modules/unctx/dist/index.mjs';
import { defu } from 'file:///Users/vitaly/Sites/hostiman_artur/mgtimes_nuxt/node_modules/defu/dist/defu.mjs';
import { getActiveHead } from 'file:///Users/vitaly/Sites/hostiman_artur/mgtimes_nuxt/node_modules/unhead/dist/index.mjs';
...
import { createError as createError$1, sanitizeStatusCode, getRequestHeaders } from 'file:///Users/vitaly/Sites/hostiman_artur/mgtimes_nuxt/node_modules/h3/dist/index.mjs';
import { withQuery, hasProtocol, parseURL, isScriptProtocol, joinURL } from 'file:///Users/vitaly/Sites/hostiman_artur/mgtimes_nuxt/node_modules/ufo/dist/index.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/casting-db6788f9.mjs').then((m) => m.default || m)
  },
  {
    name: "casting___ru",
    path: "/ru/casting",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_...slug_-d8c73eab.mjs').then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/contacts-000d4a75.mjs').then((m) => m.default || m)
  },
  {
    name: "contacts___ru",
    path: "/ru/contacts",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-31461807.mjs').then((m) => m.default || m)
  },
  {
    name: "index___ru",
    path: "/ru",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_...slug_-a4831ff8.mjs').then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-f2ea5a58.mjs').then((m) => m.default || m)
  },
  {
    name: "media___ru",
    path: "/ru/media",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_...slug_-7cddf39e.mjs').then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-c547760d.mjs').then((m) => m.default || m)
  },
  {
    name: "models___ru",
    path: "/ru/models",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/privacy-policy-f789deb9.mjs').then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_...slug_-7300eea9.mjs').then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-0996b4d2.mjs').then((m) => m.default || m)
  },
  {
    name: "services___ru",
    path: "/ru/services",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/_slug_-45966e4e.mjs').then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-a073f103.mjs').then((m) => m.default || m)
  },
  {
...
const LazyContentDoc = defineAsyncComponent(() => import('./_nuxt/ContentDoc-1389021c.mjs').then((r) => r.default));
const LazyContentList = defineAsyncComponent(() => import('./_nuxt/ContentList-3cc27dc7.mjs').then((r) => r.default));
const LazyContentNavigation = defineAsyncComponent(() => import('./_nuxt/ContentNavigation-b33814c7.mjs').then((r) => r.default));
const LazyContentQuery = defineAsyncComponent(() => import('./_nuxt/ContentQuery-e032db68.mjs').then((r) => r.default));
const LazyContentRenderer = defineAsyncComponent(() => import('./_nuxt/ContentRenderer-96552a5f.mjs').then((r) => r.default));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./_nuxt/ContentRendererMarkdown-326f59f8.mjs').then((r) => r.default));
const LazyContentSlot = defineAsyncComponent(() => import('./_nuxt/ContentSlot-30663915.mjs').then((r) => r.default));
...
const LazyMarkdown = defineAsyncComponent(() => import('./_nuxt/Markdown-0d28d388.mjs').then((r) => r.default));
const LazyProseA = defineAsyncComponent(() => import('./_nuxt/ProseA-b7addeaa.mjs').then((r) => r.default));
const LazyProseBlockquote = defineAsyncComponent(() => import('./_nuxt/ProseBlockquote-9fb10426.mjs').then((r) => r.default));
const LazyProseCode = defineAsyncComponent(() => import('./_nuxt/ProseCode-947fb7b1.mjs').then((r) => r.default));
const LazyProseCodeInline = defineAsyncComponent(() => import('./_nuxt/ProseCodeInline-45341655.mjs').then((r) => r.default));
const LazyProseEm = defineAsyncComponent(() => import('./_nuxt/ProseEm-133ed4ec.mjs').then((r) => r.default));
const LazyProseH1 = defineAsyncComponent(() => import('./_nuxt/ProseH1-24cfb2f7.mjs').then((r) => r.default));
const LazyProseH2 = defineAsyncComponent(() => import('./_nuxt/ProseH2-b61e66bf.mjs').then((r) => r.default));
const LazyProseH3 = defineAsyncComponent(() => import('./_nuxt/ProseH3-70a01287.mjs').then((r) => r.default));
const LazyProseH4 = defineAsyncComponent(() => import('./_nuxt/ProseH4-7746a647.mjs').then((r) => r.default));
const LazyProseH5 = defineAsyncComponent(() => import('./_nuxt/ProseH5-0a048353.mjs').then((r) => r.default));
const LazyProseH6 = defineAsyncComponent(() => import('./_nuxt/ProseH6-2a5afd4a.mjs').then((r) => r.default));
const LazyProseHr = defineAsyncComponent(() => import('./_nuxt/ProseHr-13ebe21e.mjs').then((r) => r.default));
const LazyProseImg = defineAsyncComponent(() => import('./_nuxt/ProseImg-b4f9e605.mjs').then((r) => r.default));
const LazyProseLi = defineAsyncComponent(() => import('./_nuxt/ProseLi-5a798948.mjs').then((r) => r.default));
const LazyProseOl = defineAsyncComponent(() => import('./_nuxt/ProseOl-ab3b55e5.mjs').then((r) => r.default));
const LazyProseP = defineAsyncComponent(() => import('./_nuxt/ProseP-ff60f1d2.mjs').then((r) => r.default));
const LazyProseStrong = defineAsyncComponent(() => import('./_nuxt/ProseStrong-81ddba79.mjs').then((r) => r.default));
const LazyProseTable = defineAsyncComponent(() => import('./_nuxt/ProseTable-9863c01d.mjs').then((r) => r.default));
const LazyProseTbody = defineAsyncComponent(() => import('./_nuxt/ProseTbody-0c7504f6.mjs').then((r) => r.default));
const LazyProseTd = defineAsyncComponent(() => import('./_nuxt/ProseTd-4753dc21.mjs').then((r) => r.default));
const LazyProseTh = defineAsyncComponent(() => import('./_nuxt/ProseTh-06163fea.mjs').then((r) => r.default));
const LazyProseThead = defineAsyncComponent(() => import('./_nuxt/ProseThead-6fc58e05.mjs').then((r) => r.default));
const LazyProseTr = defineAsyncComponent(() => import('./_nuxt/ProseTr-354098c9.mjs').then((r) => r.default));
const LazyProseUl = defineAsyncComponent(() => import('./_nuxt/ProseUl-80e28547.mjs').then((r) => r.default));
...
const layouts = {
  default: () => import('./_nuxt/default-6db92d50.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-34ae01d6.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-500-9610b918.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-ea5b6974.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export { _export_sfc as _, useRoute as a, useRequestEvent as b, createError as c, useRuntimeConfig as d, entry$1 as default, useNuxtApp as e, useState as f, useRouter as g, getComposer as h, injectHead as i, useLocalePath as j, useSwitchLocalePath as k, useLocaleHead as l, navigateTo as n, resolveUnrefHeadInput as r, useI18n as u };
