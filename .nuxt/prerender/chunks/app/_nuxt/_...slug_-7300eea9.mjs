  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(path) == "/services/parties-in-dubai" || unref(path) == "/ru/services/parties-in-dubai") {
        ...
        _push(`<div class="additional-services-section__swiper-scrollbar"></div></div></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="service__page-wrapper-img private-events__page-wrapper-img">`);
...
//# sourceMappingURL=_...slug_-7300eea9.mjs.map
