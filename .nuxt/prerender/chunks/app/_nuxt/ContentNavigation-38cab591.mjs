...
import { u as useAsyncData, q as queryContent, e as encodeQueryParams, j as jsonStringify, a as useCookie } from './query-7e240301.mjs';
...
import { u as useContentDisabled, w as withContentBase, a as addPrerenderPath, s as shouldUseClientDB } from './utils-6cb5eff9.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-e217356d.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-38cab591.mjs.map
