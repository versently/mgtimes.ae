...
import { u as useAsyncData, q as queryContent, e as encodeQueryParams, j as jsonStringify, a as useCookie } from './query-78cd0dad.mjs';
...
import { _ as __nuxt_component_0 } from './nuxt-link-b8423364.mjs';
import { u as useContentDisabled, w as withContentBase, a as addPrerenderPath, s as shouldUseClientDB } from './utils-3b18a1a6.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-b8f1fcff.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-89511583.mjs.map
