...
const Header_vue_vue_type_style_index_0_lang = ".select-city__title a{color:#000}.ar{content:url(" + publicAssetsURL("img/header/arrow.svg") + ");display:block;left:5px;position:relative;top:0;transform:rotate(0deg)}";

const Footer_vue_vue_type_style_index_0_scoped_58f1e224_lang = ".footer-banner[data-v-58f1e224]{position:relative;top:-5px}@media(max-width:575px){.footer-banner[data-v-58f1e224]{position:absolute;right:0;top:-25px}}";

const defaultStyles_4024d282 = [Header_vue_vue_type_style_index_0_lang, Footer_vue_vue_type_style_index_0_scoped_58f1e224_lang];

export { defaultStyles_4024d282 as default };
//# sourceMappingURL=default-styles.4024d282.mjs.map
