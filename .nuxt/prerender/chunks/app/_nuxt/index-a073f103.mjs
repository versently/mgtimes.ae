...
import _sfc_main$2 from './ContentDoc-1389021c.mjs';
import { u as useI18n, a as useRoute } from '../server.mjs';
import { u as useLocalePath } from './composables-abe3247e.mjs';
import { withAsyncContext, mergeProps, unref, withCtx, createVNode, openBlock, createBlock, Fragment, renderList, toDisplayString, useSSRContext } from 'file:///Users/vitaly/Sites/hostiman_artur/mgtimes_nuxt/node_modules/vue/index.mjs';
...
import './ContentRenderer-96552a5f.mjs';
import './ContentRendererMarkdown-326f59f8.mjs';
...
import 'file:///Users/vitaly/Sites/hostiman_artur/mgtimes_nuxt/node_modules/property-information/index.js';
  ...
  Component.__i18n.push({
    ...
    "resource": {
      "en": {
        ...
        "Choose your party in Dubai": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["Choose your party in Dubai"]);
        },
        "From": (ctx) => {
          const { normalize: _normalize } = ctx;
      ...
      "ru": {
        ...
        "Choose your party in Dubai": (ctx) => {
          const { normalize: _normalize } = ctx;
          return _normalize(["\u0412\u044B\u0431\u0435\u0440\u0438\u0442\u0435 \u0441\u0432\u043E\u044E \u0432\u0435\u0447\u0435\u0440\u0438\u043D\u043A\u0443 \u0432 \u0414\u0443\u0431\u0430\u0435"]);
        },
        "From": (ctx) => {
          const { normalize: _normalize } = ctx;
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_ContentList, {
        ...
        default: withCtx(({ list }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            ssrRenderList(list.slice(1), (services, index) => {
            ...
            return [
              createVNode("div", { class: "additional-services-section__swiper-wrapper" }, [
                (openBlock(true), createBlock(Fragment, null, renderList(list.slice(1), (services, index) => {
      ...
      _push(`<div class="additional-services-section__swiper-scrollbar"></div></div></div></div></div><div class="service__page-wrapper-img private-events__page-wrapper-img">`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/services/parties-in-dubai/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-a073f103.mjs.map
