...
import { u as useAsyncData, q as queryContent, e as encodeQueryParams, j as jsonStringify, a as useCookie } from './query-d51f290d.mjs';
...
import { u as useContentDisabled, w as withContentBase, a as addPrerenderPath, s as shouldUseClientDB } from './utils-2bbdf9e2.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-552cf684.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-b33814c7.mjs.map
