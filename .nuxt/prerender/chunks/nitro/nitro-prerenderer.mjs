...
import { createIPX, createIPXMiddleware } from 'file:///Users/vitaly/Sites/hostiman_artur/mgtimes_nuxt/node_modules/ipx/dist/index.mjs';
...
const _7KSZ6D = lazyEventHandler(() => {
...
const handlers = [
  ...
  { route: '/api/_content/cache.1688397977136.json', handler: _880hOV, lazy: false, middleware: false, method: "get" },
  ...
  { route: '/_ipx/**', handler: _7KSZ6D, lazy: false, middleware: false, method: undefined },
